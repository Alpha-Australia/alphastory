...
export default function TellYourStory() {
  ...
  async function regenerateImage(itemId) {
    ...
    if (!item) return;
    if (!apiKey)
      return alert("Please enter your OpenAI API key in the form above first.");
    ...
    try {
      ...
      const data = await response.json();
      if (!response.ok)
        throw new Error(data?.error?.message || "Failed to regenerate image");
  ...
  return (
    <div className="main-wrapper">
      <div className="container">
        ...
        <div className="input-section">
          <div className="api-key-section">
            ...
            />
            <small>
              Your API key is stored locally and never sent anywhere except
              OpenAI. Get one at{" "}
              <a
          ...
          <div className="button-group">
            ...
            <button
              ...
              id="downloadBtn"
              className={`download-btn ${currentImageUrl ? "visible" : ""}`}
            >
              Download Image
            </button>
          </div>
            ...
            feedItems.map((item) => (
              ...
              >
                ...
                <div className="feed-tile-info">
                  <div className="feed-tile-name">
                    {item.userName || "Anonymous"}
                  </div>
                  <div className="feed-tile-church">
                    {item.churchName || "Unknown Church"}
                  </div>
      ...
      {/* Modal */}
      <div
        className={`modal ${modalItem ? "active" : ""}`}
        onClick={(e) => {
                  ...
                  <div className="modal-user-info">
                    <div className="modal-info-item">
                      ...
                      <div className="modal-info-value">
                        {modalItem.userName || "Anonymous"}
                      </div>
                    </div>
                    <div className="modal-info-item">
                      <div className="modal-info-label">Church</div>
                      <div className="modal-info-value">
                        {modalItem.churchName || "Unknown Church"}
                      </div>
                    </div>
                  </div>
