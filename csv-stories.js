// CSV Stories Data - Parsed from alpha.csv
const alphaStories = [
  {
    id: 1,
    story: "Nick's life was marked by grief, addiction, and despair—until a desperate cry led him back to church and then to Alpha. There, a powerful encounter with God turned everything around. Now healed and sober, he shares the hope of Jesus with others.",
    source: "http://onemillion.alpha.org.au"
  },
  {
    id: 2,
    story: "From atheist to evangelist. A conversation over coffee led Sally to question everything. Wrestling with depression, purpose, and science vs faith, she took her questions to Alpha—where she discovered that doubt and belief could coexist."
  },
  {
    id: 3,
    story: "A family's faith re-discovered. As Chilli explored Alpha Youth at school, her mum, Elke, felt drawn back to church. Through Alpha, their journey united—now, three generations are active in their parish and have found a daily walk with Jesus."
  },
  {
    id: 4,
    story: "Sia was born into poverty and is a single mum and ultra-marathon runner who has been chasing God her whole life, only to realise God was with her all along."
  },
  {
    id: 5,
    story: "A doctor, a grim diagnosis, and a divine encounter. Facing stage 4 cancer, Dr. Tridiv cried out to God from his hospital bed - soon after he received his healing. Through Alpha and a local pastor's support, he found faith in Jesus and transitioned from the Hindu faith—now his family in India follows Jesus too."
  },
  {
    id: 6,
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { alphaStories, getRandomStory, getStoryById, getAllStories };
}
